...
func Generate(description string) {
	// Get the current timestamp for the migration file version
	timestamp := time.Now().Format("20060102150405.000") // Timestamp to milliseconds
	...
	// Create a new migration file with the description and timestamp
...
`, registrationKey, registrationKey)
	...
	// Write the template into the migration file
